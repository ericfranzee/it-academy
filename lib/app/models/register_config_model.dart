...
class RegisterConfigModel {
  ...
  bool? disableRegistrationVerification;
  ...
  RegisterConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    selectRolesDuringRegistration = json['selectRolesDuringRegistration']?.cast<String>() ?? [];
    ...
    disableRegistrationVerification = json['disable_registration_verification'];
  }
...
class ReferralSettings {
  ...
  ReferralSettings.fromJson(Map<String, dynamic> json) {
    ...
    affiliateUserCommission = json['affiliate_user_commission']?.toString();
    storeAffiliateUserCommission = json['store_affiliate_user_commission']?.toString();
    affiliateUserAmount = json['affiliate_user_amount']?.toString();
    referredUserAmount = json['referred_user_amount']?.toString();
    referralDescription = json['referral_description']?.toString();
  }
